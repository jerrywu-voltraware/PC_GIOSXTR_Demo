...
def test_app_metadata_uses_requested_version_and_icon():
    ...
    assert APP_WINDOW_TITLE == "PC GIOSXTR Demo V1.0.1"
...
def test_pyinstaller_spec_uses_versioned_exe_icon_and_version_info():
    ...
    assert 'name="PC_GIOSXTR_Demo_V1.0.1"' in spec
    ...
    assert "StringStruct('FileVersion', 'V1.0.1')" in version_info
    assert "StringStruct('ProductVersion', 'V1.0.1')" in version_info
